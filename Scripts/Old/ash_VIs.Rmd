...
atkin1_3983<-read.csv("C://Users//catherine.chan//Desktop//Thesis Data//Ash Trees//Ash_nelsopet//Outputs//atkin1_3983_df.csv",check.names = FALSE)
...
atkin1_3983_matrix   <-as.matrix(atkin1_3983   [-1:-2])
...
atkin1_3983_speclib   <-speclib  (atkin1_3983_matrix   ,HDW_wv[1:272])
...
atkin1_3983_VIs       <-vegindex(atkin1_3983_speclib       ,index=VIs)

##rename columns
colnames(atkin1_3983_VIs  )<-VIs

##lets do a logical test on EightMile_HDW_VIs to see if strange values exist
test3<-lapply(atkin1_3983_VIs,range)%>%as.data.frame%>%t()%>%as.data.frame
...
atkin1_3983_VIs_A  <-cbind(atkin1_3983   [1:2],atkin1_3983_VIs   )
...
colnames(atkin1_3983_VIs_A )[-1:-2]<-newcolnames
##DIM725940 274

##lets do a logical test again to the image 
test6<-lapply(atkin1_3983_VIs_A[-1:-2], range)%>%as.data.frame%>%t()%>%as.data.frame()
...
write.csv(atkin1_3983_VIs_A,"C://Users//catherine.chan//Desktop//Thesis Data//Ash Trees//Ash_nelsopet//Outputs//atkin1_3983_VIs.csv" ,row.names = FALSE)
