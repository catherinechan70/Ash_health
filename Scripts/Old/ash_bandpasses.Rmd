...
#&&& Blueberry0725SpecLib<-readRDS("E://Chan_Thesis_Missions//PSR Scans//Outputs//0725//Blueberry0725SpecLib.rds")
...
#&&&Blueberry0725SpecLib_HDW<-spectrolab::resample(Blueberry0725SpecLib,Headwall_wv)
...
#&&&Blueberry0725SpecLib_test<-Blueberry0725SpecLib_HDW%>%as.data.frame()%>%dplyr::select(-sample_name)

####Lets run that test again
#&&&tst2<-lapply(Blueberry0725SpecLib_test[-1:-7],range)%>%as.data.frame%>%t()%>%as.data.frame
...
#&&&Blueberry0725SpecLib_HDW1<-Blueberry0725SpecLib_test%>%subset(`445.739`>0) ##dim()  1974  333

##Now lets convert to a spectral object and add metadata
#&&&Blueberry0725SpecLib_HDW<-Blueberry0725SpecLib_HDW1[-1:-7]%>%as.spectra()
#&&&meta(Blueberry0725SpecLib_HDW)<-data.frame(Blueberry0725SpecLib_HDW1[1:7], stringsAsFactors = FALSE)

####Lets run that test again
#&&&tst3<-lapply(Blueberry0725SpecLib_HDW1[-1:-7],range)%>%as.data.frame%>%t()%>%as.data.frame
...
write(Headwall_wv,"C://Users//catherine.chan//Desktop//Thesis Data//Ash Trees//Ash_nelsopet//Outputs//Headwall_wv")

##Now lets save our New headwall spectral library
#&&&saveRDS(Blueberry0725SpecLib_HDW,"E://Chan_Thesis_Missions//PSR Scans//Outputs//0725//Blueberry0725SpecLib_HDW.rds")```
